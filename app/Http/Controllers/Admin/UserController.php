    ...
    */
    ...
    public function data()
    {
        ...
        return Datatables::of($users)
            ...
            ->addColumn('actions', '@if ($id!="1")<a href="{{{ url(\'admin/user/\' . $id . \'/edit\' ) }}}" class="btn btn-success btn-sm iframe" ><span class="glyphicon glyphicon-pencil"></span>  {{ trans("admin/modal.edit") }}</a>
                ...
                @endif')
            ->removeColumn('id')
            ->escapeColumns(['users.name'])
            ->rawColumns(['users.confirmed', 'confirmed', 'actions'])
            ->make();
    }
